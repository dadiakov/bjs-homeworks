...
describe('Домашнее задание к занятию 3.2 «Прототип массива, функции высшего порядка»', () => {
  ...
  describe('Задача №2', () => {
    ...
    it('функция compareArrays должна возвращать ложь при разных массивах, если часть первого массива совпадает со вторым', () => {
      expect(compareArrays([1,2,3], [1,2,3,2342,5345,654,232])).toBeFalsy();
    });

    it('функция compareArrays должна возвращать ложь при разных массивах, если часть второго массива совпадает со вторым', () => {
      expect(compareArrays([1,2,3,2342,5345,654,232], [1,2,3])).toBeFalsy();
    });
